    ...
    <StaticPageShell>
      <main style={{ maxWidth: 820, margin: "0 auto", padding: "72px 24px 96px" }}>
        ...
        <p style={{ fontSize: 17, color: "#6b7280", lineHeight: 1.75, margin: "0 0 34px" }}>
          Estes termos iniciais posicionam o PasseiPMPE como uma plataforma web estática para estudo de PMPE Soldado. A versão final será revisada antes do lançamento público do fluxo de questões.
        </p>
        {[
          ["Uso do site", "O website apresenta informações sobre o PasseiPMPE, páginas institucionais, blog e a futura experiência de questões gratuitas para PMPE Soldado."],
